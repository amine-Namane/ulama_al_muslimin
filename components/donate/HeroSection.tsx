      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/20 text-white px-4 py-2 rounded-full text-sm font-medium mb-6 border border-white/30 backdrop-blur-sm">
            ...
            تبرع لجمعية العلماء المسلمين
          </div>
          
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            <span className="text-amber-300">تبرعك</span> يُحدث فرقاً
          </h1>
          <p className="text-xl text-emerald-100 max-w-3xl mx-auto leading-relaxed">
            ساهم في دعم تعليم القرآن الكريم ونشر العلم الشرعي. كل تبرع يساهم في إحداث تأثير إيجابي مستدام 
            في حياة الآلاف من الطلاب والأسر في الجزائر.
          </p>
        </motion.div>
      </div>
    </section>
